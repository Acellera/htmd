...
#    print(xx.shape)
    if(  not np.array_equal( numpy.squeeze( x2.coords ) ,numpy.squeeze(x1.coords[:,:,i])  ) ):
       print( x1.coords[:,:,i] )
       print( x2.coords )
       print("ERROR " + str(i) )
       sys.exit(1)
...
full=XTCread(filename='datasets/2//filtered/e52s7_e16s4f11/e52s7_e16s4f11-SDOERR_thrombinLig6x2-0-1-RND6631_9.filtered.xtc' )
part=XTCread(filename='datasets/2//filtered/e52s7_e16s4f11/e52s7_e16s4f11-SDOERR_thrombinLig6x2-0-1-RND6631_9.filtered.xtc', frames=[168,169])
