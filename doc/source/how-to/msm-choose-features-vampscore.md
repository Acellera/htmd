...
Decide objectively, rather than by intuition, which features to build your MSM on, how many TICA dimensions to keep, and what TICA lag to use. The cross-validated VAMP-2 score ({py:func}`~htmd.projections.vamp.vampScore`) rates how much of the slow dynamics a featurization resolves; you score your candidates and keep the best one. This is the variational feature-selection idea of McGibbon and Pande.
