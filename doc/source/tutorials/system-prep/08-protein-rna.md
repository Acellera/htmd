...
**You will learn:** how to build a solvated, ionised protein-RNA complex, using the same flow as a canonical protein build, with the RNA force field already covered by HTMD's defaults.
