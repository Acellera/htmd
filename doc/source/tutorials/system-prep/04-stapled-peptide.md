...
- Other staple chemistries (lactam, thioether, click triazole) use the same flow: detection sees the inter-NCAA bond from the input file's connectivity, regardless of which atoms anchor the staple.
