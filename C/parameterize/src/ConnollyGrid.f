...
C
      ...
      character*80  STRING, GAUFILE(256), SURFSTR(256), str
...
*Read Gaussian keywords
      ISTR = 0
      do While( RGLINE(11,GAUFILE,ISTR,256) .GT. 0 )
      enddo
 
*Read commentaries
      I = RGLINE(11,GAUFILE,ISTR,256)
...
C Write Gaussian Input file
      ...
      INTEGER   IU, ISTR
      CHARACTER*80 GAUFILE(256), STRING
      LOGICAL   FIRST
      INTEGER   I,L
      INTEGER   STRLEN
      LOGICAL   BEGIN
