...
*/
void NWDP_TM(int len1, int len2, double gap_open, int j2i[], double **val, bool **path, double **score)
{
...
void NWDP_TM(double **x, double **y, int len1, int len2, double t[3], double u[3][3], double d02, double gap_open, int j2i[], double **val, bool **path)
{
	//NW dynamic programming for alignment
	//not a standard implementation of NW algorithm
...
//+ss
void NWDP_TM(int *secx, int *secy, int len1, int len2, double gap_open, int j2i[], double **val, bool **path)
{
	//NW dynamic programming for alignment
	//not a standard implementation of NW algorithm
