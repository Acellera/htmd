...
### Download HTMD
HTMD can be downloaded from www.htmd.org. If you want to use this git repository, still download it using conda first to have all dependencies and the set PYTHONPATH to the git directory.
