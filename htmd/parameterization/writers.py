from htmd.parameterization.util import _qm_method_name, getImproper
...
def writeFRCMOD(mol, parameters, typemap, filename):
...
run 0'''
        ...
        writeFRCMOD(mol, parameters, typemap, frcFile)
