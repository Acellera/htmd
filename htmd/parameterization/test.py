...
class TestParameterize(unittest.TestCase):
    ...
    def test_h2o2_gaff2(self):
        ...
        self._execute(refDir, resDir, 'parameterize input.mol2 -f GAFF2 --charge-type Gasteiger --min-opt no --no-dihed')
        self._testFiles(refDir, resDir)

    def test_h2o2_outdir(self):
        refDir = os.path.join(self.dataDir, 'h2o2_outdir')
        resDir = os.path.join(self.testDir, 'h2o2_outdir')
        self._execute(refDir, resDir, 'parameterize input.mol2 -f GAFF2 --charge-type Gasteiger --min-opt no --no-dihed -o dir')
        self._testFiles(refDir, resDir)
    ...
    def test_h2o2_esp(self):
        ...
        self._execute(refDir, resDir, 'parameterize input.mol2 --min-opt no --no-dihed')
        self._testFiles(refDir, resDir)
    ...
    def test_h2o2_dihed_fix(self):
        ...
        self._execute(refDir, resDir, 'parameterize input.mol2 --min-opt no --charge-type Gasteiger --dihed-opt no')
        self._testFiles(refDir, resDir)
    ...
    def test_h2o2_dihed_fix_restart(self):
        ...
        self._execute(refDir, resDir, 'parameterize input.mol2 --charge-type Gasteiger --min-opt no --dihed-opt no')
        self._testFiles(refDir, resDir)
    ...
    def test_h2o2_dihed_opt(self):
        ...
        self._execute(refDir, resDir, 'parameterize input.mol2 --charge-type Gasteiger --min-opt no')
        self._testFiles(refDir, resDir)
    ...
    def test_glycol_dihed_fix_restart_2(self):
        ...
        self._execute(refDir, resDir, 'parameterize input.mol2 -d {} --charge-type Gasteiger --min-opt no --dihed-opt no'.format(' '.join(dihedrals)))
        self._testFiles(refDir, resDir)
    ...
    def test_benzamidine_gasteiger(self):
        ...
        self._execute(refDir, resDir, 'parameterize input.mol2 --charge-type Gasteiger --min-opt no --no-dihed')
        self._testFiles(refDir, resDir)
    ...
    def test_benzamidine_gaff(self):
        ...
        self._execute(refDir, resDir, 'parameterize input.mol2 -c 1 -ff GAFF --charge-type Gasteiger --min-opt no --no-dihed')
        self._testFiles(refDir, resDir)
    ...
    def test_benzamidine_gaff2(self):
        ...
        self._execute(refDir, resDir, 'parameterize input.mol2 -c 1 -ff GAFF2 --charge-type Gasteiger --min-opt no --no-dihed')
        self._testFiles(refDir, resDir)
    ...
    def test_benzamidine_cgenff(self):
        ...
        self._execute(refDir, resDir, 'parameterize input.mol2 -c 1 -ff CGenFF_2b6 --charge-type Gasteiger --min-opt no --no-dihed')
        self._testFiles(refDir, resDir)
    ...
    def test_benzamidine_rtf_prm(self):
        ...
        self._execute(refDir, resDir, 'parameterize input.mol2 -c 1 -ff CGenFF_2b6 --rtf-prm input.rtf input.prm --charge-type Gasteiger --min-opt no --no-dihed')
        self._testFiles(refDir, resDir)
