...
class TestParameterize(unittest.TestCase):
    ...
    def test_h2o2_gaff2(self):
        ...
        self._run(refDir, resDir, 'parameterize input.mol2 -f GAFF2 --charge-type Gasteiger --no-min --no-dihed')
        self._test(refDir, resDir)

    def test_h2o2_outdir(self):
        refDir = os.path.join(self.dataDir, 'h2o2_outdir')
        resDir = os.path.join(self.testDir, 'h2o2_outdir')
        self._run(refDir, resDir, 'parameterize input.mol2 -f GAFF2 --charge-type Gasteiger --no-min --no-dihed -o dir')
        self._test(refDir, resDir)
    ...
    def test_h2o2_esp(self):
        ...
        self._run(refDir, resDir, 'parameterize input.mol2 --no-min --no-dihed')
        self._test(refDir, resDir)
    ...
    def test_h2o2_dihed_fix(self):
        ...
        self._run(refDir, resDir, 'parameterize input.mol2 --no-min --charge-type Gasteiger --no-dihed-opt')
        self._test(refDir, resDir)
    ...
    def test_benzamidine_gasteiger(self):
        ...
        self._run(refDir, resDir, 'parameterize input.mol2 --charge-type Gasteiger --no-min --no-dihed')
        self._test(refDir, resDir)
    ...
    def test_benzamidine_gaff(self):
        ...
        self._run(refDir, resDir, 'parameterize input.mol2 -c 1 -ff GAFF --charge-type Gasteiger --no-min --no-dihed')
        self._test(refDir, resDir)
    ...
    def test_benzamidine_gaff2(self):
        ...
        self._run(refDir, resDir, 'parameterize input.mol2 -c 1 -ff GAFF2 --charge-type Gasteiger --no-min --no-dihed')
        self._test(refDir, resDir)
    ...
    def test_benzamidine_cgenff(self):
        ...
        self._run(refDir, resDir, 'parameterize input.mol2 -c 1 -ff CGenFF_2b6 --charge-type Gasteiger --no-min --no-dihed')
        self._test(refDir, resDir)
    ...
    def test_benzamidine_rtf_prm(self):
        ...
        self._run(refDir, resDir, 'parameterize input.mol2 -c 1 -ff CGenFF_2b6 --rtf-prm input.rtf input.prm --charge-type Gasteiger --no-min --no-dihed')
        self._test(refDir, resDir)
