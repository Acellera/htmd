from htmd.parameterization.step import ScriptStep, StepSet, QMScriptStep
...
class NonpolarSet(StepSet):
    def __init__(self):
        ...
        self.add(ScriptStep(120, "nonpolar", "fit_esp",
                            ["110:mol.xpsf", "110:mol-esp.dat", "110:mol-opt.xyz", "110:elem-list.txt",
                             "110:mol-cgrid.out:cal-esp.out",
