...
#define X(atom, frame, nframes, nf3) atom*nf3+frame
#define Y(atom, frame, nframes, nf3) atom*nf3+nframes+frame
#define Z(atom, frame, nframes, nf3) atom*nf3+2*nframes+frame
