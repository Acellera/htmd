...
class MoleculeGrid:
    ...
    >>> #mol.write('H2O.xyz')  # Uncomment for visualization
    ...
    >>> #grid.writeXYZ('H2O_default.xyz')  # Uncomment for visualization
    ...
    >>> #grid.writeXYZ('H2O_1_2__50.xyz')  # Uncomment for visualization
    """
