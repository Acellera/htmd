...
class BaseProgressBar(object):
    ...
    def __init__(self, denominator, max_width=None, eta_every=1):
        ...
        self._eta_string = ''
        self._eta_count = 1
        #self.numerator_lock = threading.Lock()
...
class ProgressBar(BaseProgressBar):
    ...
    def progress(self, increment=1):
        ...
        show_progressbar(self)

    def stop(self):
        self.numerator = self.denominator
        self._eta.eta_epoch = 0
        show_progressbar(self, force=True)
        hide_progressbar(self)
