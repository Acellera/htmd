...
def _write_residue_mapping(molbuilt, mol_orig, outdir):
    ...
    try:
        ...
        logger.error(f"Error writing residue mapping: {e}")
...
def build(
    ...
    disulfide, custombonds, remove = _prepareMolecule(
...
def _prepare_build(
    ...
    # --- Detect cyclic segments and write PDB files ---
    cyclic = _detect_cyclic_segments(mol)
