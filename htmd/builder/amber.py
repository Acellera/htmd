...
def build(
    ...
    if disulfide is not None and len(disulfide) and isinstance(disulfide[0][0], str):
        disulfide = convertDisulfide(mol_orig, disulfide)
        disulfide = _mapDisulfide(disulfide, mol, mol_orig)
    ...
    if execute:
        ...
        if ionize:
            ...
            newmol = ionizePlace(
                mol_orig, anion, cation, anionatom, cationatom, nanion, ncation
            )
