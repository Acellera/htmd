...
$Parameters->{_ExitifNotParameterized}   =  0;
...
open(EPSILON, ">nonbond_epsilon_partial.dat");
open(RMIN, ">nonbond_rmin_partial.dat");

open(B0, ">bond_b0_partial.dat");
open(KB, ">bond_kb_partial.dat");

open(KTHETA, ">angle_ktheta_partial.dat");
open(THETA0, ">angle_theta0_partial.dat");

open(N, ">dihedral_n_partial.dat");
open(KCHI, ">dihedral_kchi_partial.dat");
